...
-In this Site-B repo, Only NYC site cofiguration is there which contains one keycloak and two infinispan instances.
...
4] open browser and hit below url->
    1]https://localhost:443/      ---for NYC keycloak (Username:admin   Pass:admin)
    2]https://localhost:31222     ---for NYC Infinispan(Primary) (Username:admin   Pass:passsword)
    3]https://localhost:31223     ---for NYC Infinispan(Backup/replica) (Username:admin   Pass:passsword)
